...
read_from_file = raw_input("Read data from file [Y/n]: ")
...
if read_from_file == 'y':
    ...
    while True:
        try:
            file_name = raw_input("File name (in same directory): ")
...
if request_data == "null":
    ...
    is_json = raw_input("Should data be JSON formatted [Y/n]: ")
